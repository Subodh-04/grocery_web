...
const { addToCart, decreasequantityfromcart, removefromcart, viewCart } = require("../controllers/cart_controller");
...
router.delete("/cart/delete", protect, authorize("customer"), removefromcart);
router.patch("/cart/remove", protect, authorize("customer"), decreasequantityfromcart);
